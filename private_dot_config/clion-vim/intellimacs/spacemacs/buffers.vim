...
let g:WhichKeyDesc_Buffers_ListBuffers = "<leader><leader>    list-buffers"
nnoremap <leader><leader>    :action RecentFiles<CR>
vnoremap <leader><leader>    :action RecentFiles<CR>

" Close current tab
let g:WhichKeyDesc_Buffers_KillBuffer = "<C-c>    kill-buffer"
nnoremap <C-c>    :action CloseContent<CR>
vnoremap <C-c>    <Esc>:action CloseContent<CR>
...
" Next Tab
let g:WhichKeyDesc_Buffers_NextBuffer = "<C-l>    next-buffer"
nnoremap <C-l>    :action NextTab<CR>
vnoremap <C-l>    <Esc>:action NextTab<CR>
...
" Previous Tab
let g:WhichKeyDesc_Buffers_PreviousBuffer = "<C-h>bp    previous-buffer"
nnoremap <C-h>    :action PreviousTab<CR>
vnoremap <C-h>    <Esc>:action PreviousTab<CR>
